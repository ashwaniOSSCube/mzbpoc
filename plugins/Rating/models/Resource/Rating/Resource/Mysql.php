...
class Resource_Rating_Resource_Mysql extends Pimcore_Model_Resource_Mysql_Abstract
{
    ...
    {
        $data = $this->db->fetchAll("SHOW COLUMNS FROM plugin_rating_ratings");
        foreach ($data as $d) {
    ...
    {
        //TODO check this one or remove it
        try {
