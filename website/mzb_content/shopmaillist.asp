...
<div style="clear:both"></div>
				...
				<!-- END SHOPPAGE_HEADER.HTM --><div class="breadcrumb"><a href="default.asp"> Home </a>&nbsp;:<a href="shopcustadmin.asp">Customer Service</a>:Join our mailing List</div>

<h1>Join our mailing List</h1>

<form name="shipping" method="post" action="shopmaillist.asp">
...
<div class="comment_title fontbold">Please enter your details for future updates on our product range</div>
...
<table border="0" cellpadding="3" cellspacing="3" align="center"><tr><td class="al vt" width="150">Remove from mailing list</td><td class="al vt" width="150">
