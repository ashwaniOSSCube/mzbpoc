...
<div style="clear:both"></div>
				...
				<!-- END SHOPPAGE_HEADER.HTM --><form name="form1" method="post" action="shopprojectlogin.asp">
...
<div class="comment_title fontbold">Enter your project number and email address</div>
<div class="comment_text"> 
<div class="blog_review_container" >

<div class="invoice_summary_container">
  <fieldset>
    <label>* Your Name (First Name  &amp; Last Name )</label>
    <input size="25" class="txtfield" name="stryourname" value="" />
    <div class="cb"></div>
  </fieldset>
        
  <fieldset>
    <label>* Email </label>
    <input size="25" class="txtfield" name="strpemail" value="" />
    <div class="cb"></div>
  </fieldset>
</div>
