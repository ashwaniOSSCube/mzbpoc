...
<div style="clear:both"></div>
				...
				<!-- END SHOPPAGE_HEADER.HTM --><div class="breadcrumb"><a href="default.asp"> Home </a>&nbsp;:&nbsp; Search </div>

<h1> Search </h1>
<div id="searchform">
<div class="noproductmessage">Search for products by keyword, category or subcategory.<br>Check one or more categories<br>or enter up to 10 keywords separated by commas.</div><br />

<form name="form1" method="post" action="shopsearch.asp?search=Yes">

<div class="comment_title fontbold">Advanced Search</div>
<div class="comment_text"> 
<div class="blog_review_container" >

    <table class="fl applywidthauto words">
      <tr>
    ...
    <table class="fl applywidthauto fieldchooser">
      <tr>
        <td>
<span class='fontbold'> Search &nbsp;Product Fields</span>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  
  <tr>
    <td width="30"><input type="checkbox" name="searchFields" value="cname" checked="checked" /></td>
    <td align="left">Name</td>
  </tr>
  
  <tr>
    <td width="30"><input type="checkbox" name="searchFields" value="cdescription" checked="checked" /></td>
...
<div class="searchfilters">
    <div class="searchresultsperpage">
	<span class='fontbold'>Results per page</span> <br />
      <select name="howmanyitems" class="txtfielddropdown">
...
<span class='fontbold'>Brands</span><br />
<select name="category" class="txtfielddropdown">
  <option value="all">All</option>
  
  <option value="8">Chase & Sanborn</option>
  
  <option value="209">Krispy Kreme Doughnuts Coffee</option>
  
  <option value="217">Reveille Coffee</option>
  
  <option value="2">Segafredo Zanetti</option>
    ...
    <div>
      <table class="searchprice">
        <tr>
          <td><span class='fontbold'>Low Price</span><br />
            <input size="10" name="lowprice" class="txtfield" />
          </td>
          <td><span class='fontbold'>High Price</span><br />
            <input size="10" name="highprice" class="txtfield" />
          </td>
        </tr>
      </table>
    </div>
  ...
  <div class="submit_btn_container">
    <input class="submitbtn" type="submit" name="action" id="action" value=" Search " />
