...
<div style="clear:both"></div>
				...
				<!-- END SHOPPAGE_HEADER.HTM --><div class='breadcrumb'><a href='default.asp'> Home </a>&nbsp;:&nbsp;Login</div>
  <h1>
  Previous customers can just login 
  </h1>
  <div id="loginform">
  <div class="row visible-xs-block">
  	
<table width="100%" cellspacing="6" cellpadding="0" class="logintable">
<tr>
  <!--6.08 - Translate titles and buttons-->
  <td class="al">
  <span class='fontbold'>Start As New User</span>
  </td>
  </tr>
  <tr>
  <td class="dottedBorder vt al" width="50%">
  New customers can create an account so that you can shop faster in the future and keep track of orders you have made in the past. <br />
  <br />
  
  <div align="right">
  <input type="button" class="submitbtn" value="Sign Up" onclick="location.href='shopcustregister.asp'" />
  </div>
  
  </td></tr><tr>
  <td class="dottedBorder vt al" width="50%">
  Returning customers can login using the form below. <br />
...
<input type="hidden" name="genpredefinedsecuritycode" value="MGQM2563KEXL7030JCER3325AKXA8114XYDF7037FCXM6656LLBH2556AEWN5845WBMT4261ESRK4846PYWT1081NVGZ1540DTDG" />
  ...
  <table cellpadding="2" cellspacing="1" border="0" width="100%">
    <tr>
      ...
      <td><input class="txtfield" size="24" name="strLastname" value=""></td>
    </tr>
    <tr>
      <td width="30%">Email </td>
      <td><input size="24" class="txtfield" name=strEmail></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><div align="right">
  ...
  <img src="images/site/customerlogin.gif" class="iconlogin" alt=" " />
  <table width="100%" cellspacing="6" cellpadding="0" class="logintable">
  <tr>
  <!--6.08 - Translate titles and buttons-->
  <td class="al">
