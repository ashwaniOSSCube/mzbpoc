...
<div class="row"  style="height:90px;background-image:url(templates/default-3cols/images/logo-bg-main.jpg
...
<div style="clear:both;"></div>
	...
	<div class="container">
		...
		<div id="header" class="container visible-lg-block visible-md-block visible-sm-block">
			<div class="columns row" style="background-image:url(templates/default-3cols/images/logo-bg-main.jpg
);">
...
<input name='category' value='ALL' type='hidden'>
		...
		<div id="content">            
            ...
            <div class="columns">
				<!-- side bar -->
				<div class="col-lg-2 col-md-2 col-sm-2 visible-lg-block visible-md-block visible-sm-block">
...
<div style="clear:both"></div>
				...
				<!-- END SHOPPAGE_HEADER.HTM --><div class='breadcrumb'><a href='default.asp'> Home </a>&nbsp;:Contact us</div>
<h1>Contact us</h1>

<form name="contactform" method="post" action="shopcustcontact.asp">
...
<div class="comment_title fontbold">Please leave us a message</div>
<div class="comment_text"> 
<div class="blog_review_container" >
<fieldset>
<label>* First name</label>

<input class="txtfield inputfield" size="20" name="strfirstname" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>* Last name</label>

<input class="txtfield inputfield" size="20" name="strlastname" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>* E-mail address </label>

<input class="txtfield inputfield" size="20" name="strEmail" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>* Subject</label>

<input class="txtfield inputfield" size="20" name="strsubject" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>  Street address</label>

<input class="txtfield inputfield" size="20" name="strStreetAddress" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>  City</label>

<input class="txtfield inputfield" size="20" name="strFormCity" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>  State</label>

<input class="txtfield inputfield" size="20" name="strFormState" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>  Zip</label>

<input class="txtfield inputfield" size="20" name="strFormZip" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>  Country</label>

<input class="txtfield inputfield" size="20" name="strFormCountry" value="" />
<div class="cb"></div>
</fieldset>
<fieldset>
<label>  Phone</label>

<input class="txtfield inputfield" size="20" name="strFormPhone" value="" />
<div class="cb"></div>
</fieldset>
<fieldset><label>* Brand</label><select name="strFormBrand" class="inputfield"><option value="">Select one</option><option value="Chock full o'Nuts" >Chock full o'Nuts</option><option value="Chase &amp; Sanborn" >Chase &amp; Sanborn</option><option value="Hills Bros." >Hills Bros.</option>  <option value="Hills Bros. Cappuccino" >Hills Bros. Cappuccino</option><option value="Kauai" >Kauai</option><option value="Krispy Kreme" >Krispy Kreme</option><option value="MJB" >MJB</option><option value="Reveille" >Reveille</option><option value="Segafredo" >Segafredo</option></select><div class="cb"></div></fieldset>
<fieldset><span style="font-weight:bold;">Join Our E-Mail List for Specials and Product Announcements?</span> <input value="Yes" type="checkbox" name="strFormMailingList" style="border: 1px solid #8c9cab; color: #666; margin-top:0;"><div class="cb"></div></fieldset>
<fieldset>
<label>* Reason for contacting us</label>

<textarea class="txtfield" rows="10" name="strcomment" cols="45"></textarea>
<div class="cb"></div>
</fieldset>
<fieldset>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
 ...
 <tr>
  <td>
   ...
   <input type="text" name="securityCode" id="securityCode" size="12" maxlength="12" autocomplete="off" class="txtfield" />
  </td>
 </tr>
</table></div>
<div class="cb"></div>
...
<div id="contactusinfo">
  <table>
    <tr>
      <td class="fontbold">Company </td>
      <td>Massimo Zanetti Beverage USA, Inc.</td>
    </tr>
    <tr>
      <td class="fontbold">Address </td>
      <td>E-Commerce Department<br />1200 Court Street<br />Portsmouth VA 23704<br />US</td>
    </tr>
    <tr>
      <td class="fontbold">Phone </td>
      <td>757-215-7376 Direct<br />844-365-BREW (2739) Toll-free<!--1-844-365-BREW (2739)--></td>
    </tr>
<!--    <tr>
    ...
    <tr>
      ...
      <td><a href="mailto:ecommerce@mzb-usa.com">ecommerce@mzb-usa.com</a><!--<a href='mailto:ecommerce@mzb-usa.com'>ecommerce@mzb-usa.com</a>--></td>
    </tr>
...
<div class="sidefreetextnobox 352ft" ><div id="free-shipping"> Spend $100 or More on <br>
  Products and Receive<br>
  <span class="free">Free Shipping</span><br>
  <img src="/mzb_usa_com/store/images/freeShippingBox.jpg" border="0"><br>
  <span class="disclaimer">*excluding shipments to <br>
  HI, AK, & Canada.</span> </div>

</div>
<div class="sidefreetextnobox 301ft" ><br /><br /><!-- BoldChat Live Chat Button HTML v4.00 (Type=Web,ChatButton=MZB Chat Button,Website=MZB) -->
<div style="text-align: center; white-space: nowrap;"> <a href="https://livechat.boldchat.com/aid/697672610211716982/bc.chat?resize=true&cbdid=3586444453971015714&wdid=2806526051958288638" target="_blank" onclick="window.open((window.pageViewer && pageViewer.link || function(link){return link;})(this.href + (this.href.indexOf('?')>=0 ? '&' : '?') + 'url=' + escape(document.location.href)), 'Chat3412718178011852680', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=480');return false;">
  <div id="support"><script language="JavaScript" type="text/javascript"> var bccbId = Math.random(); document.write(unescape('<img alt="Live chat by BoldChat" src="https://www.shopmzb.com/mzb_usa_com/store/images/supportButton.png" id=' + bccbId + ' />')); var bccb = {id: bccbId, bdid: '3586444453971015714', rdid: null, type: 'chat'}; var _bcvma = _bcvma || []; if(window.pageViewer && pageViewer.addButton) pageViewer.addButton(button); else _bcvma.push(['addButton', bccb]);</script></div>
  </a> </div>
<!-- /BoldChat Live Chat Button HTML v4.00 --> </br>
</div>
<div style="clear:both"></div>
</div>
</div>
