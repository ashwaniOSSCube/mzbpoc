...
<div style="clear:both"></div>
				...
				<!-- END SHOPPAGE_HEADER.HTM --><div class='breadcrumb'><a href='default.asp'>Home</a>&nbsp;:Customer Service</div><h1>Customer Service</h1><table class="customerservice"><tr><th style="background-image:url(images/icons/user.gif)">Customer Registration</th></tr><tr align='left'><td><ul><li><a href='shopcustadminlogin.asp'>Login</a></li>
<li><a href='shopcustregister.asp'>Customer Registration</a></li>
</ul></td></tr></table><table class="customerservice"><tr><th style="background-image:url(images/icons/package.gif)">Orders</th></tr><tr align='left'><td><ul><li><a href='shopstatus.asp'>Review previous Orders</a></li>
<li><a href='shopprojectsummary.asp'>Invoice Summary</a></li>
</ul></td></tr></table><table class="customerservice"><tr><th style="background-image:url(images/icons/messages.gif)">Contact us</th></tr><tr align='left'><td><ul><li><a href='shopmaillist.asp'>Join our mailing List</a></li>
<li><a href='shopcustcontact.asp'>Contact us</a></li>
</ul></td></tr></table>				<!-- START SHOPPAGE_TRAILER.HTM -->
								</div>
				</div> 
